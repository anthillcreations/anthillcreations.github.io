...
if (!("scramble" in Array.prototype)) {
  Object.defineProperty(Array.prototype, "scramble", {
    ...
    var quiz = [
        {
            "question"      :   "Question: Guess the state based on the pictures",
            "image"         :   "Andaman and Nicobar Islands_front.png",
            "choices"       :   [
            ...
            "correct"       :   "Andaman Nicobar Islands",
            "explanation"   :   " Andaman Nicobar Islands - Capital - Port Blair",
        },
		{
            "question"      :   "Question: Guess the state based on the pictures",
            "image"         :   "Karnataka_Front.png",
            "choices"       :   [
                                    "Andaman Nicobar Islands",
                                    "Karnataka",
                                    "Maharashtra",
            ...
            "correct"       :   "Karnataka",
            "explanation"   :   " Karnataka - Capital- Bangalore ",
        },
				{
            "question"      :   "Question: Guess the state based on the pictures",
            "image"         :   " Maharashtra_Front.png",
            "choices"       :   [
                                    "Andaman Nicobar Islands",
                                    "Karnataka",
                                    "Maharashtra",
            ...
            "correct"       :   "Maharashtra",
            "explanation"   :   " Maharashtra, Capital - Mumbai ",
        },
				{
            "question"      :   "Question: Guess the state based on the pictures",
            "image"         :   "Andhra_Front.png",
            "choices"       :   [
                                    "Andhra Pradesh",
                                    "Karnataka",
                                    "Maharashtra",
            ...
            "explanation"   :   " Andhra Pradesh, Capital -Vijaywada",
        },
				{
            "question"      :   "Question: Guess the state based on the pictures",
            "image"         :   " Assam_Front.png",
            "choices"       :   [
                                    "Arunachal Pradesh",
                                    "Karnataka",
                                    "Assam",
            ...
            "correct"       :   "Assam",
            "explanation"   :   " Assam, Capital - Guwahati",
        },
...
<div class="col-sm-6 formControls rsform-block-submit">
	<button type="submit" name="form[submit]" id="submit" onclick="copyText()" class="rsform-submit-button  btn btn-primary"> HOME </button>			
</div>	
</body>
</html>
